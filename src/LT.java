package practica_final; // canviau-ho pel vostre package <----
 ...
 * 
 * /Manual d'ús\______________________________________________________________
 * Aquesta classe proporciona mecanismes per llegir l'entrada a través del
 * teclat en prémer la tecla de retorn (intro).
 * 
 *  * _/Cambio del color en visualización \___________________________________
 * 
 ...
 *           BLANCO   --> 8
 * 
 * _/Lectura del teclat\______________________________________________________
 * 
 ...
 * 
 * _/Configuració\____________________________________________________________
 ...
 * 
 * /Historial de versions\____________________________________________________
 * versió 2.2:
 *  - Mètode readLong.
 *  - Privatitzat read.
